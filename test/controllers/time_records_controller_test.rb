...
class TimeRecordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create time_record" do
    assert_difference('TimeRecord.count') do
      post time_records_url, params: { time_record: { date: @time_record.date, entrance: @time_record.entrance, output: @time_record.output, user_id: @time_record.user_id } }, as: :json
    end
  ...
  test "should update time_record" do
    patch time_record_url(@time_record), params: { time_record: { date: @time_record.date, entrance: @time_record.entrance, output: @time_record.output, user_id: @time_record.user_id } }, as: :json
    assert_response 200
  end
